...
## 6. `content/actividades/c3-18-escala-mayor-o-menor.json` (línea 25)
...
## 7. `content/actividades/c3-20-que-compas-es.json` (línea 26)
...
## 8. `content/actividades/c3-24-quien-compuso-esta-melodia.json` (línea 25)
...
## 9. `content/actividades/c3-25-el-compas-de-doce.json` (línea 27)
...
## 10. `content/actividades/c3-26-bailes-y-compases.json` (línea 25)
...
## 11. `content/actividades/c3-31-ritmos-del-mundo.json` (línea 25)
...
## 12. `content/actividades/c3-34-coloca-la-nota-en-clave-de-fa.json` (línea 25)
