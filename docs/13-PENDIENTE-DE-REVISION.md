...
## 22. `content/actividades/c3-18-escala-mayor-o-menor.json` (línea 25)
...
## 23. `content/actividades/c3-20-que-compas-es.json` (línea 26)
...
## 24. `content/actividades/c3-24-quien-compuso-esta-melodia.json` (línea 25)
...
## 25. `content/actividades/c3-25-el-compas-de-doce.json` (línea 27)
...
## 26. `content/actividades/c3-25-el-compas-de-doce.json` (línea 149)
...
## 27. `content/actividades/c3-34-coloca-la-nota-en-clave-de-fa.json` (línea 34)
...
## 28. `content/actividades/c3-35-suena-bien-o-roza.json` (línea 25)
...
## 29. `content/actividades/c3-38-ocho-estilos.json` (línea 25)
...
## 30. `content/actividades/c3-43-el-preludio-de-bach.json` (línea 26)
...
## 31. `content/actividades/c3-43-el-preludio-de-bach.json` (línea 173)
...
## 32. `content/actividades/c3-43-el-preludio-de-bach.json` (línea 175)

], "enPantalla": "Cuatro bloques en fila, uno por compás, y un cursor que los recorre mientras el piano toca el arpegio de Bach en bucle. Cada bloque lleva el nombre de su acorde y un color: el primero y el último son iguales porque los dos son do; el segundo (re menor) y el tercero (sol séptima) van de otro color. El niño no toca nada: mira, escucha y nota dónde cambia el color de la música. No hay respuesta ni final: se para cuando el maestro quiere y se puede volver a poner.", "sinPantalla": "Dibuja cuatro cajas en la pizarra, la primera y la cuarta del mismo color, y toca o pon el comienzo del Preludio señalando la caja que suena. Si hay teclado o metalófono, toca tú el arpegio despacio en cada acorde: do-mi-sol-do, re-fa-la-do, sol-si-re-fa, do-mi-sol-do (PENDIENTE DE REVISIÓN PEDAGÓGICA), y que la clase levante la mano cuando note que ha cambiado de caja. Con la voz sale igual: cantar el arpegio de do y luego el de re menor, y oír que el color cambia aunque el dibujo sea el mismo.", "masFacil": "Quédate con dos bloques: el primero y el segundo. Es un solo cambio, de do a re menor, y se oye claro. Que levanten la mano al cambiar. Cuando salga, añadir el tercero y el cuarto. Y antes de todo, cantar el arpegio de do (do, mi, sol, do) hasta que se reconozca solo, sin el piano.", "masDificil": "Que sean ellos quienes señalen el bloque en la pizarra mientras suena, sin cursor. Luego, cantar la nota más grave de cada bloque: do, do, si, do (PENDIENTE DE REVISIÓN PEDAGÓGICA), y oír cómo el tercer bloque baja un poco y pide volver. Y para quien va sobrado: tocar el arpegio de do y el de re menor en el metalófono a la vez que la app, cada uno en su bloque.",

## 33. `content/actividades/c3-44-para-elisa.json` (línea 26)
...
## 34. `content/actividades/c3-45-en-la-gruta-del-rey-de-la-montana.json` (línea 32)
...
## 35. `content/actividades/c3-46-marcha-radetzky.json` (línea 26)
...
## 36. `content/actividades/c3-47-el-danubio-azul.json` (línea 26)
...
## 37. `content/actividades/c3-48-cada-obra-con-su-nombre.json` (línea 25)
...
## 38. `content/actividades/c3-48-cada-obra-con-su-nombre.json` (línea 238)
...
## 39. `content/actividades/c3-49-la-primavera-de-vivaldi-con-figuras.json` (línea 31)
...
## 40. `content/actividades/c3-50-las-quince-notas-de-do-a-do.json` (línea 41)
...
## 41. `content/actividades/c3-51-clave-de-fa-las-dos-octavas.json` (línea 34)
...
## 42. `content/actividades/inf-11-cancion-con-pictogramas.json` (línea 216)
...
## 43. `content/actividades/inf-21-fuerte-o-flojito.json` (línea 89)
...
## 44. `content/actividades/inf-23-sube-o-baja.json` (línea 124)
...
## 45. `content/actividades/inf-29-cucu-sol-y-mi.json` (línea 30)
...
## 46. `content/actividades/tr-11-bailes-y-compases.json` (línea 25)
...
## 47. `content/actividades/tr-11-bailes-y-compases.json` (línea 311)
...
## 48. `content/actividades/tr-14-ritmos-del-mundo.json` (línea 25)
...
## 49. `content/actividades/tr-14-ritmos-del-mundo.json` (línea 243)
...
## 50. `content/actividades/tr-17-milo-se-presenta.json` (línea 27)
...
## 51. `content/actividades/tr-18-sol-se-presenta.json` (línea 27)
...
## 52. `content/actividades/tr-19-dora-se-presenta.json` (línea 27)
...
## 53. `content/actividades/tr-20-rex-se-presenta.json` (línea 27)
...
## 54. `content/actividades/tr-21-fara-se-presenta.json` (línea 27)
...
## 55. `content/actividades/tr-22-laia-se-presenta.json` (línea 27)
...
## 56. `content/actividades/tr-23-simon-se-presenta.json` (línea 27)
...
## 57. `content/actividades/tr-24-doby-se-presenta.json` (línea 27)
...
## 58. `content/criterios.json` (línea 2)
...
## 60. `src/motor/afinacion.ts` (línea 67)
...
## 62. `src/motor/evaluacion.ts` (línea 197)
...
## 63. `src/motor/musicograma.ts` (línea 32)
...
## 64. `src/motor/pautaRitmica.ts` (línea 14)
...
## 65. `src/motor/rejillaRitmica.ts` (línea 9)
...
## 66. `src/motor/repaso.ts` (línea 18)
...
## 67. `tools/auditoria.mjs` (línea 272)
...
## 68. `tools/dificultad.mjs` (línea 73)
...
## 69. `tools/dificultad.mjs` (línea 251)
...
## 70. `tools/muestras-provisionales.py` (línea 98)
...
## 71. `tools/muestras-provisionales.py` (línea 144)
