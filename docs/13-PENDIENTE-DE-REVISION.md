...
> que la provocó. Generado el 2026-09-10.
...
## 7. `content/actividades/c2-23-termina-o-se-queda-a-medias.json` (línea 25)
...
## 8. `content/actividades/c2-24-familias-de-instrumentos.json` (línea 25)
...
## 9. `content/actividades/c2-28-vals-marcha-o-tango.json` (línea 25)
...
## 10. `content/actividades/c2-31-alegre-o-triste.json` (línea 25)
...
## 11. `content/actividades/c2-36-que-estilo-suena.json` (línea 25)
...
## 12. `content/actividades/c2-37-quien-canta.json` (línea 25)
...
## 13. `content/actividades/c2-38-la-manana-de-grieg-con-la-pandilla.json` (línea 26)
...
## 14. `content/actividades/c2-39-la-nana-de-brahms-con-la-pandilla.json` (línea 26)
...
## 15. `content/actividades/c2-40-la-pequena-serenata-nocturna.json` (línea 26)
...
## 16. `content/actividades/c2-41-el-cisne.json` (línea 26)
...
## 17. `content/actividades/c3-04-mapa-de-una-obra.json` (línea 120)
...
## 18. `content/actividades/c3-18-escala-mayor-o-menor.json` (línea 25)
...
## 19. `content/actividades/c3-20-que-compas-es.json` (línea 26)
...
## 20. `content/actividades/c3-24-quien-compuso-esta-melodia.json` (línea 25)
...
## 21. `content/actividades/c3-25-el-compas-de-doce.json` (línea 27)
...
## 34. `content/actividades/inf-29-cucu-sol-y-mi.json` (línea 30)
...
## 35. `content/criterios.json` (línea 2)
...
## 37. `src/motor/afinacion.ts` (línea 67)
...
## 39. `src/motor/evaluacion.ts` (línea 165)
...
## 40. `src/motor/musicograma.ts` (línea 32)
...
## 41. `src/motor/pautaRitmica.ts` (línea 14)
...
## 42. `src/motor/rejillaRitmica.ts` (línea 9)
...
## 43. `src/motor/repaso.ts` (línea 18)
...
## 44. `tools/auditoria.mjs` (línea 271)
...
## 45. `tools/dificultad.mjs` (línea 73)
...
## 46. `tools/dificultad.mjs` (línea 251)
...
## 47. `tools/muestras-provisionales.py` (línea 98)
...
## 48. `tools/muestras-provisionales.py` (línea 144)
