...
## 2. `content/actividades/c2-23-termina-o-se-queda-a-medias.json` (línea 25)
...
## 3. `content/actividades/c2-24-familias-de-instrumentos.json` (línea 25)
...
## 4. `content/actividades/c2-28-vals-marcha-o-tango.json` (línea 25)
...
## 5. `content/actividades/c2-31-alegre-o-triste.json` (línea 25)
...
## 6. `content/actividades/c2-36-que-estilo-suena.json` (línea 25)
...
## 7. `content/actividades/c2-37-quien-canta.json` (línea 25)
...
## 8. `content/actividades/c3-18-escala-mayor-o-menor.json` (línea 25)
...
## 9. `content/actividades/c3-20-que-compas-es.json` (línea 26)
...
## 10. `content/actividades/c3-24-quien-compuso-esta-melodia.json` (línea 25)
...
## 11. `content/actividades/c3-25-el-compas-de-doce.json` (línea 27)
...
## 12. `content/actividades/c3-26-bailes-y-compases.json` (línea 25)
...
## 13. `content/actividades/c3-31-ritmos-del-mundo.json` (línea 25)
...
## 14. `content/actividades/c3-34-coloca-la-nota-en-clave-de-fa.json` (línea 25)
...
## 15. `content/actividades/c3-35-suena-bien-o-roza.json` (línea 25)
...
## 16. `content/actividades/c3-38-ocho-estilos.json` (línea 25)
...
## 17. `content/criterios.json` (línea 2)
...
## 19. `src/motor/afinacion.ts` (línea 67)
...
## 21. `src/motor/evaluacion.ts` (línea 127)
...
## 22. `src/motor/musicograma.ts` (línea 32)
...
## 23. `src/motor/rejillaRitmica.ts` (línea 9)
...
## 24. `src/motor/repaso.ts` (línea 18)
...
## 25. `tools/auditoria.mjs` (línea 271)
...
## 26. `tools/dificultad.mjs` (línea 73)
...
## 27. `tools/dificultad.mjs` (línea 251)
...
## 28. `tools/muestras-provisionales.py` (línea 98)
...
## 29. `tools/muestras-provisionales.py` (línea 144)
