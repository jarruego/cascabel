...
## 8. `content/actividades/c1-42-marramamiau.json` (línea 498)

], "$comment": "MELODÍA, RITMO Y LETRA DE UNA SOLA FUENTE, y documentada: el **Fondo de Música Tradicional IMF-CSIC**, pieza M35-0600, recogida en Sevilla por Arcadio de Larrea Palacín a la informante Isabel Pozo Lozano, catalogada como canción de corro. Se descargó su MusicXML y se leyeron de ahí las 31 notas con sus alturas, sus figuras y su sílaba: nada está escrito de memoria ni deducido. Cita: Óscar David Castillo Pérez, «Estaba el señor Don Gato», Fondo de Música Tradicional IMF-CSIC, ed. E. Ros-Fábregas, https://musicatradicional.imf.csic.es/piece/64973 (2026-09-15). **Lo que se publica es nuestro JSON**: la obra es tradicional anónima y de dominio público, y de la transcripción no viaja nada — se ha usado para verificar la melodía, que es lo que no se puede inventar. Antes de esto la actividad iba sin melodía, con todo en un sol, porque las tres transcripciones que se habían mirado eran variantes distintas y mezclarlas habría dado una canción que no era ninguna. Al aparecer una fuente con MusicXML, se rehízo entera. PENDIENTE DE REVISIÓN PEDAGÓGICA: (1) El tempo. La fuente marca negra = 120; aquí va a 76 porque las cuatro semicorcheas de «ja-do-con-el» a 120 son 125 ms y eso no se toca a los siete años. A 76 son 197 ms. (2) Esta versión sevillana dice «con el marra miau, miau, miau» donde la que circula por los colegios dice «maramamiau»; se respeta la de la fuente. Las otras estrofas de la ficha son de la versión común y se señalan como tales. (3) El compás 10 es de 3/4 en la fuente, dentro de una pieza en 2/4. Es así en el original y se ha respetado.", "instrumento": "piano", "fondo": "flauta" },
