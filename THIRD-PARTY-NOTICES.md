...
| `public/iconos/*.svg` (90: la bombilla añadida el 2026-09-07, y cuarenta y dos más el 2026-09-10 para lenguaje musical, historia, estilos y el banco de sonidos) | Iconos de actividad | OpenMoji · HfG Schwäbisch Gmünd | https://openmoji.org | **CC BY-SA 4.0** | 2026-09-06 | licencia en `LICENSE.txt` del repositorio oficial |
