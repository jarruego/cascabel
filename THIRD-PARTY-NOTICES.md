...
| `public/iconos/*.svg` (94: la bombilla añadida el 2026-09-07, cuarenta y dos más el 2026-09-10 para lenguaje musical, historia, estilos y el banco de sonidos, y ese mismo día la bicicleta y los tres de la percusión corporal: chasquido, muslo y pie) | Iconos de actividad | OpenMoji · HfG Schwäbisch Gmünd | https://openmoji.org | **CC BY-SA 4.0** | 2026-09-06 | licencia en `LICENSE.txt` del repositorio oficial |
